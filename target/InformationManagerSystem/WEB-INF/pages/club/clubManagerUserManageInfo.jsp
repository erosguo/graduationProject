                        ...
                        <c:forEach items="${pageList.dataList}" var ="newUser">
                            <tr class="danger">
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-success" onclick="location.href='${pageContext.request.contextPath}/User/quitMyClub?clubId=${newUser.userId}'">通知</button>
                                </td>
                            </tr>
