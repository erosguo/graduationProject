        ...
        <section class="content">
            <ul class="nav nav-tabs">
                <li role="presentation" >
                    <a href="<%=path %>/User/showClubDiscussInfo?page=1&size=3" >讨论清单</a>
                </li>
            ...
            <div class="box box-primary">
                ...
                <c:if test="${empty pageList.dataList}">
                    <h1 class="text-center">您还没有参与任何讨论，请加入一个讨论</h1>
                </c:if>
                ...
                <c:if test="${not empty pageList.dataList}">
                    <div class="box-body">
                        ...
                        <div class="table-box">
                            ...
                            <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                                <thead>
                                <tr>
                                    <th class="sorting_desc">讨论名称[降序]</th>
                                    <td>讨论内容</td>
                                    <td>最新评论</td>
                                    <td>点击数</td>
                                    <td>可选操作</td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>${clubDiscuss.clubDiscussComment}</td>
                                        <td>${clubDiscuss.clubDiscussClickNumber}</td>
                                        <td>
                                                <%--<button class="btn btn-default"></button>--%>
                                            <button class="btn btn-success" onclick="location.href='${pageContext.request.contextPath}/ClubManager/showClubDiscussDetail?clubDiscussId=${clubDiscuss.clubDiscussId}'">详情</button>
                                        </td>
                                    </tr>
                    ...
                    <div class="box-footer">
                        ...
                        <div class="box-tools pull-right">
                            <ul class="pagination">
                                <li>
                                    <a aria-label="Previous" href="${pageContext.request.contextPath}/User/showMyClubDiscussInfo?page=1&size=${pageList.pageSize}">首页</a>
                                </li>
                                <c:if test="${pageList.currentPage>1}">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/User/showMyClubDiscussInfo?page=${pageList.currentPage-1}&size=${pageList.pageSize}">上一页</a>
                                    </li>
                                </c:if>

                                <c:forEach begin="1" end="${pageList.totalPage}" var="pageNum">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/User/showMyClubDiscussInfo?page=${pageNum}&size=${pageList.pageSize}">${pageNum}</a>
                                    </li>
                                </c:forEach>
                                <c:if test="${pageList.currentPage<pageList.totalPage}">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/User/showMyClubDiscussInfo?page=${pageList.currentPage+1}&size=${pageList.pageSize}">下一页</a>
                                    </li>
                                </c:if>

                                <li>
                                    <a aria-label="Previous" href="${pageContext.request.contextPath}/User/showMyClubDiscussInfo?page=${pageList.totalPage}&size=${pageList.pageSize}">尾页</a>
                                </li>
                            </ul>
                        </div>
...
<script>
    function changePageSize() {
        ...
        //向服务器发送请求，改变每页显示条数
        location.href="${pageContext.request.contextPath}/User/showMyClubDiscussInfo?page=1&size="+pageSize;
    }
</script>
</html>
